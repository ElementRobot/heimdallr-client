 ...
 * "locked" subtype and data of "true". The locked state will persist in 
 * Heimdallr until the provider sends another event packet with a "locked" subtype.
 * <br> 
 ...
 * packet with a subtype <tt>'reactor_temperature'</tt>, data <tt>'75.03 C'</tt>,
 ...
 * of th the field to a UUID before sending it to the provider. Each time
 ...
 * array of subtypes for the given packet type specified by the key.
 *
 * @method
